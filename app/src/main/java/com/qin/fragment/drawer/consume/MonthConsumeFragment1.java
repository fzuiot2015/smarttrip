...
public class MonthConsumeFragment1 extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_consume_month, null, false);
    ...
    private void initDatas() {
        ...
        lists.add(new TSixMonthFragment());
        lists.add(new TSevenMonthFragment());
        lists.add(new TEightMonthFragment());
