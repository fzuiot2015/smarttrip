...
public class RepairHistoryfragment extends BaseFragment  {
    ...
    Unbinder unbinder;
    @BindView(R.id.rlv_history_repair)
    RecyclerView mRlvHistoryRepair;
    @BindView(R.id.ll_history_repair)
    LinearLayout mLlHistoryRepair;
    @BindView(R.id.tv_history_repair)
    TextView mTvHistoryRepair;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        initDialog();
        mRlvHistoryRepair.setLayoutManager(new LinearLayoutManager(mActivity));
        mRlvHistoryRepair.setItemAnimator(new DefaultItemAnimator());
        mRlvHistoryRepair.addItemDecoration(new MarginDecorationVertical(20));
        return view;
    }
        ...
        OkGo.<String>post(ConstantValues.URL_HISTORYPARKING)
                ...
                .execute(new StringCallback() {
                    ...
                    public void onSuccess(Response<String> response) {
                        Log.i("RepairHistoryfragment", response.body());
                        mDialog.dismiss();
    ...
    private void parseeData(String json) {
        ...
        if (code.equals("0")&&mResultList.size()>0) {
            mTvHistoryRepair.setVisibility(View.GONE);
            mLlHistoryRepair.setVisibility(View.VISIBLE);
            mAdapter = new ParkingHistoryRecyclerViewAdapter(mResultList);
            mRlvHistoryRepair.setAdapter(mAdapter);
            ...
            mTvHistoryRepair.setVisibility(View.VISIBLE);
            mLlHistoryRepair.setVisibility(View.GONE);
        }
    }
