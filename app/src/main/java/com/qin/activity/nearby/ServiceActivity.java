...
public class ServiceActivity extends AppCompatActivity implements
        ...
        loadingLayout.setOnReloadListener(new LoadingLayout.OnReloadListener() {
            ...
            public void onReload(View v) {
                ...
                if (boundFlag == 1) {
                    ...
                    accessNetParking(100000, firstPage);
                } else if (boundFlag == 5) {
                    accessNetParking(500000, firstPage);
                }
            }
        });
    }
    ...
    public void initPopWindow(Context context, int layoutRes, int width, int height) {
        popView = View.inflate(this, R.layout.popwindow_search_bound_service, null);
    ...
    private void accessNetParkingLoadMore(int radius, int pageNum) {
        ...
        OkGo.<String>post(ConstantValues.URL_TOLIET).tag(this).upJson(json).execute(new StringCallback() {
            ...
            public void onSuccess(Response<String> response) {
                ...
                if (results.size() == 0) {
                    ToastUtils.showBgResource(ServiceActivity.this, "已加载所有数据");
                } else {
...
//                refreshParking.setVisibility(View.GONE);
        ...
        try {
            ...
            if (status.equals("0")) {
                ...
                if (mResultsList.size() <= 0) {
                    mTvToiletNo.setVisibility(View.VISIBLE);
                    mRefreshToilet.setVisibility(View.GONE);
                } else {
                    mTvToiletNo.setVisibility(View.GONE);
                    mRefreshToilet.setVisibility(View.VISIBLE);
                }
                ...
                mAdapter.setOnItemClickListener(new ToiletRecyclerViewAdapter.OnItemClickListener() {
                    ...
                    public void onItemClick(View view, ToiletRecyclerViewAdapter.ViewName viewName, int postion) {
                        ...
                        if (ToiletRecyclerViewAdapter.ViewName.IMAGEVIEW == viewName) {
                            ToastUtils.showBgResource(ServiceActivity.this, "跳转" + postion);
                        }
                    }
                });
            } else {
                ToastUtils.showBgResource(ServiceActivity.this, message);
            }
        } catch (Exception e) {
            e.printStackTrace();
            ToastUtils.showBgResource(ServiceActivity.this, "获取异常");
        }
    }
    ...
    public void onLoadMore(RefreshLayout refreshLayout) {
        if (firstPage <= mPageNum) {
            ...
            if (boundFlag == 1) {
                ...
                accessNetParkingLoadMore(100000, firstPage);
            } else if (boundFlag == 5) {
                accessNetParkingLoadMore(500000, firstPage);
            }
        } else {
            mRefreshToilet.finishLoadMore();
        }
    ...
    public void onRefresh(RefreshLayout refreshLayout) {
        if (boundFlag == 1) {
            ...
            refreshAccessNetParking(100000);
        } else if (boundFlag == 5) {
            refreshAccessNetParking(500000);
        }
